...
public class BostersInitialize : MonoBehaviour
{
    ...
    public void Initialize(Timer timer, List<Shelf> shelves)
    {
        _timer = timer;
        _shelfs = shelves;
    }
    ...
    {
        //if (_money.CurrentMoney >= _stopTimer.Prise)
        //{
    ...
    {
        //if (_money.CurrentMoney >= _collectingPair.Prise)
        //{
    ...
    {
        //if (_money.CurrentMoney >= _replaceObjects.Prise)
        //{
    ...
    {
        //if (_money.CurrentMoney >= _shuffle.Prise)
        //{
    ...
    {
        //if (_money.CurrentMoney >= _bomb.Prise)
        //{
